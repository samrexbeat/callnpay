    ...
    <div className="flex base">
        ...
        <Navbar/>
            ...
            <div className="main">
                ...
                <div className="flex ">
                <h4 className="user py-10 px-12 ">Cards</h4>
                <NavLink to="/create-card" className="mx-0 no-underline">
                <button className="buttonu py-1 mt-4">New Card</button>
                </NavLink>
                </div>
                ...
                <div className=" px-12">
                    <NavLink to="#" className="mr-7 no-underline text-black">
                    Used Cards
                    </NavLink>
